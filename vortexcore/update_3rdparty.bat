...
xcopy ..\3rdparty\steamaudio\bin\Windows\x64\*.dll .\bin\debug /I /D /Y
xcopy ..\3rdparty\steamaudio\bin\Windows\x64\*.pdb .\bin\debug /I /D /Y

xcopy ..\3rdparty\steamaudio\bin\Windows\x64\*.dll .\bin\release /I /D /Y
xcopy ..\3rdparty\steamaudio\bin\Windows\x64\*.pdb .\bin\release /I /D /Y
